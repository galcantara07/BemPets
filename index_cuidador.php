          ...
          <ul class="nav nav-pills mb-2 me-5">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button"
                aria-expanded="false">Cuidador</a>
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="editar.php?id=7">Editar perfil</a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 text-center col-12 fundo">
            ...
            <div class="d-flex justify-content-center">
              <a href="cuidador_logado.html">
                <button class="botao-ser">Ser um cuidador</button>
              </a>
            </div>
          </div>
        </div>
